...
class Xox_Woo_Carousel_Admin {
	...
	public function enqueue_styles() {
		...
		if( $post_type == 'xox-carousel-slider' || is_page( array('xox-carousel-slider-edit-theme') ) ){
			wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/xox-woo-carousel-admin.css', array(), $this->version, 'all' );
		}
	}
	...
	public function enqueue_scripts() {
		...
		global $post_type;
		if( $post_type == 'xox-carousel-slider' || is_page( array('xox-carousel-slider-edit-theme') ) ){
			wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/xox-woo-carousel-admin.js', array( 'jquery' ), $this->version, false );
		}
	}
